  ...
  return (
    <div className="container">
      <div className="d-flex flex-column align-items-center justify-content-between">
        ...
        <div className="col fs-6 text-light">
        ...
        <div className="card my-4" style={{ width: "18rem" }}>
          ...
          <div className="card-body">
            <p className="card-text">
              <b>Developed By</b> <h3 className="text-primary" style={{fontFamily:"serif"}}><a href="https://github.com/pauljayanta17" class="link-primary">Cool Coder</a></h3>
            </p>
          </div>
        </div>
      </div>
